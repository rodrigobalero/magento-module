...
class Mundipagg_Model_Order_Payment {
	...
	/**
	 * @param Mage_Sales_Model_Order              $order
	 * @param Mundipagg_Model_Standard $standard
	 * @return Mage_Sales_Model_Order_Invoice
	 */
	public function orderPaid(Mage_Sales_Model_Order $order, Mundipagg_Model_Standard $standard) {
		try {
