...
class Mundipagg_Controller_Abstract extends Mage_Core_Controller_Front_Action {
	...
	protected function getSessionId() {
		...
		if (is_null($sessionId) || $sessionId == false || empty($sessionId)) {
			...
			Mundipagg_Model_Customer_Session::setSessionId($sessionId);
		}
