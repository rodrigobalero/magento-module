...
class Mundipagg_Test_Selenium_DebitTest extends Mundipagg_Test_Selenium_Abstract
{
    //001,237,341,VBV,cielo_mastercard,cielo_visa
    protected $_debitTypes = array(
        '001',
        //'237', // @todo O banco especificado não está configurado para a loja
        '341',
        //'VBV', // @todo O banco especificado não está configurado para a loja
        'cielo_mastercard',
        'cielo_visa'
    );
