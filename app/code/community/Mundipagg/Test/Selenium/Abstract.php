...
class Mundipagg_Test_Selenium_Abstract extends PHPUnit_Extensions_Selenium2TestCase {
    ...
    public function setUp(){
        ...
        shell_exec('echo "" > ../var/log/Mundipagg.log');
...
//endif;
    ...
    protected function tearDown(){
        //$this->deleteCustomerIfExists();
        print shell_exec('cat ../var/log/Mundipagg.log');
